...
def fazer_reserva(page, horario):
    ...
    # Screenshot para ver o estado após clicar na data
    page.screenshot(path=f"apos_data_{horario.replace(':', '')}h.png")
    print(f"Screenshot salvo: apos_data_{horario.replace(':', '')}h.png")
...
with sync_playwright() as p:
    browser = p.chromium.launch(headless=False)  # browser visível para debug
